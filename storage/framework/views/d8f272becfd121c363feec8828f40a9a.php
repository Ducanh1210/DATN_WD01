...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-avatar','data' => ['user' => Auth::user(),'size' => '40','class' => 'user-avatar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(Auth::user()),'size' => '40','class' => 'user-avatar']); ?>
...
<?php endif; ?>
            ...
            <ul class="sidebar-menu">
                <?php if(auth()->guard()->check()): ?>
                <li>
                    <a href="<?php echo e(route('client.missions')); ?>" class="menu-item">
                ...
                <li>
                    <a href="<?php echo e(route('client.profile')); ?>#tab-itineraries" class="menu-item">
                ...
                <li>
                    <a href="<?php echo e(route('client.profile')); ?>" class="menu-item">
                ...
                <li class="sidebar-bottom-item">
                    <a href="<?php echo e(route('client.pano_service')); ?>" class="menu-item menu-item--muted menu-item--text-only">
    ...
    <div class="top-search-panel" id="topSearchPanel">
        <div class="unified-command-dock">
            ...
            <select id="mapCategoryFilter" class="dock-category-select" aria-label="Lọc theo danh mục">
                ...
                <?php $__currentLoopData = $locations->pluck('category')->filter()->unique('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="bottom-drawer-wrapper open" id="featured-drawer">
        ...
        <div class="vr-floating-hex-menu">
            <a href="<?php echo e(route('client.landing')); ?>" class="vr-hex-btn" id="vrBtnHome" title="Trang chủ" onclick="event.stopPropagation();">
            ...
            <a href="<?php echo e(route('client.missions')); ?>" class="vr-hex-btn" id="vrBtnGame" title="Trò chơi & Nhiệm vụ" onclick="event.stopPropagation();">
                <span class="material-symbols-rounded">sports_esports</span>
                <span class="vr-hex-tooltip">Nhiệm vụ</span>
            </a>

            <a href="<?php echo e(route('client.pano_service')); ?>" class="vr-hex-btn" id="vrBtn360" title="Tour VR 360" onclick="event.stopPropagation();">
        ...
        <div class="drawer-content">
            <div class="featured-loc-scroll" id="featuredLocScroll">
                <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="#" class="featured-loc-card" data-cat="<?php echo e($loc->category ? $loc->category->id : ''); ?>" onclick="flyToLocation(<?php echo e($loc->id); ?>); return false;">
            ...
            <div class="monuments-modal-header">
                ...
                <div class="monuments-controls-bar">
                    ...
                    <div class="monuments-count-info" id="monumentsCountInfo">
                        <span><strong id="monumentsCurrentCount"><?php echo e($locations->count()); ?></strong> địa điểm</span>
                    </div>
                </div>
            </div>
                ...
                <div class="monuments-grid" id="monumentsGrid">
                    <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="monument-card"
                             data-cat="<?php echo e($loc->category ? $loc->category->id : ''); ?>"
                             data-name="<?php echo e(mb_strtolower($loc->name, 'UTF-8')); ?>"
                             onclick="selectMonumentFromModal(<?php echo e($loc->id); ?>)">
                            <div class="monument-card-img-box">
                                <img src="<?php echo e($loc->thumbnail_url ?: 'https://placehold.co/400x250/1e293b/ffffff?text=Ninh+Binh'); ?>"
                                     alt="<?php echo e($loc->name); ?>"
                                     class="monument-card-img"
                                     loading="lazy">
                                <div class="monument-card-title-overlay"><?php echo e(mb_strtoupper($loc->name, 'UTF-8')); ?></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <script>
        ...
        function getCategoryIconHtml(cat) {
            ...
            const iconPath = cat.icon_url || (cat.icon ? (cat.icon.startsWith('http') ? cat.icon : '<?php echo e(asset("")); ?>' + cat.icon.replace(/^\//, '')) : null);
            ...
            widgetClaimDailyBtn.addEventListener("click", function() {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (parentContainer) {
                            parentContainer.innerHTML = '<div style="display: flex; align-items: center; gap: 2px; font-weight: 700; color: #334155; font-size: 0.6rem;">+' + (data.coins || 10) + ' <img src="<?php echo e(asset("images/xu.png")); ?>" alt="xu" style="width: 11px; height: 11px; object-fit: contain;"></div><span style="font-weight: 600; color: #475569; font-size: 0.56rem; white-space: nowrap;">Đã điểm danh</span>';
                        }
    ...
    <?php echo $__env->make('client.components.contribution-modals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.chatbot-widget','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal63b9d94996cdb9dd99b06f7392c9bb0d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal63b9d94996cdb9dd99b06f7392c9bb0d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.trip-planner-widget','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('trip-planner-widget'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal63b9d94996cdb9dd99b06f7392c9bb0d)): ?>
<?php $attributes = $__attributesOriginal63b9d94996cdb9dd99b06f7392c9bb0d; ?>
<?php unset($__attributesOriginal63b9d94996cdb9dd99b06f7392c9bb0d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal63b9d94996cdb9dd99b06f7392c9bb0d)): ?>
<?php $component = $__componentOriginal63b9d94996cdb9dd99b06f7392c9bb0d; ?>
<?php unset($__componentOriginal63b9d94996cdb9dd99b06f7392c9bb0d); ?>
<?php endif; ?>
</body>
</html><?php /**PATH D:\laragon\www\datnv2\DuAn_TN\resources\views/client/home.blade.php ENDPATH**/ ?>