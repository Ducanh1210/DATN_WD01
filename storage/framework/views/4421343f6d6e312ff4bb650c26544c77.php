...
unset($__errorArgs, $__bag); ?>" placeholder="Nhập tên đăng nhập" value="<?php echo e(old('username')); ?>" autofocus>
                        </div>
...
unset($__errorArgs, $__bag); ?></span>
                ...
                <div class="auth-footer">
                    <div>Chưa có tài khoản? <a href="<?php echo e(route('register')); ?>">Đăng ký ngay</a></div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/client/auth/login.blade.php ENDPATH**/ ?>