<?php $__env->startSection('title', 'Trung Tâm Nhiệm Vụ & Đổi Thưởng - Ninh Bình Travel Hub'); ?>

<?php $__env->startSection('body_class', 'missions-shell'); ?>
...
<div class="ms-shell">
    <header class="ms-top">
        <div class="ms-top__left">
            <a href="<?php echo e(route('home')); ?>" class="ms-back">
                <i class="fa-solid fa-arrow-left" aria-hidden="true"></i>
                <span>Bản đồ</span>
            </a>
            <a href="<?php echo e(route('client.missions')); ?>" class="ms-brand">
                <img class="ms-brand__logo" src="<?php echo e(asset('images/logo.png')); ?>" alt="">
        ...
        <div class="ms-top__right">
            ...
            <?php if($user): ?>
                <div class="ms-xu-pill">
                    <img src="<?php echo e(asset('images/xu.png')); ?>" alt="xu" style="width: 18px; height: 18px; object-fit: contain;">
                    <span id="headerUserPoints"><?php echo e(number_format($user->points)); ?></span>
                </div>
...
<?php endif; ?>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-sm btn-light" style="border-radius: 2px; font-weight: 600;">Đăng nhập</a>
            <?php endif; ?>
        </div>
    </header>
            ...
            <div id="emptyCatMessage" class="text-center py-5 bg-white border d-none" style="border-radius: 2px;">
                ...
                <p class="text-muted small mb-0">Các phần quà mới sẽ sớm được cập nhật.</p>
                    ...
                    <div class="row g-3" id="shopItemGrid">
                        <?php $__empty_1 = true; $__currentLoopData = $shopFrames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $frame): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                                        ...
                                        <div class="item-img-compact bg-light d-flex align-items-center justify-content-center">
                                            <?php if($frame->image_url): ?>
                                                <div class="avatar-frame-wrapper has-png-frame" style="width: 58px; height: 58px;">
                                                    <img src="<?php echo e($avatarPreview); ?>" alt="Avatar preview" style="width: 100%; height: 100%; border-radius: 50%; object-fit: cover;">
                                                    <img src="<?php echo e(asset($frame->image_url)); ?>" class="avatar-frame-png-overlay" alt="<?php echo e($frame->name); ?>">
                                                </div>
                                            <?php else: ?>
                                                <div class="avatar-frame-wrapper <?php echo e($frame->css_style); ?>" style="width: 58px; height: 58px;">
                                                    <img src="<?php echo e($avatarPreview); ?>" alt="Avatar preview" style="width: 100%; height: 100%; border-radius: 50%; object-fit: cover;">
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <h6 class="item-name-compact text-truncate"><?php echo e($frame->name); ?></h6>
                                        <div class="item-desc-compact text-truncate"><?php echo e($frame->description ?: 'Khung avatar có thể đổi bằng xu.'); ?></div>
                                    </div>
                                    <div>
                                        <div class="item-price-compact">
                                            <img src="<?php echo e(asset('images/xu.png')); ?>" alt="xu" style="width: 16px; height: 16px; object-fit: contain; vertical-align: -2px;" class="me-0.5">
                                            <span><?php echo e(number_format((int) $frame->required_points)); ?> xu</span>
                                        </div>
                                        <?php if(auth()->guard()->guest()): ?>
                                            <a href="<?php echo e(route('login')); ?>" class="btn btn-action-compact text-decoration-none text-center d-block">Đăng nhập để đổi</a>
                                        <?php else: ?>
                                            <button class="btn btn-action-compact btn-buy-frame" type="button" data-id="<?php echo e($frame->id); ?>" data-name="<?php echo e($frame->name); ?>" data-points="<?php echo e((int) $frame->required_points); ?>" <?php echo e($canAfford ? '' : 'disabled'); ?>>
                                                <?php echo e($canAfford ? 'Đổi khung' : 'Không đủ xu'); ?>
                ...
                <div>
                    ...
                    <h1 class="ms-hero__title">
                        <?php if(auth()->guard()->check()): ?>
                            Xin chào, <?php echo e($user->display_name ?? $user->username); ?>
                    ...
                    <div class="ms-hero__points">
                        <?php echo e($user ? number_format($user->points) : '0'); ?>

                        <img src="<?php echo e(asset('images/xu.png')); ?>" alt="xu" style="width: 26px; height: 26px; object-fit: contain; margin-left: 4px;">
                    </div>
                </div>
                <div>
                    ...
                    <div class="d-flex align-items-center gap-1 mb-3">
                        <?php for($day = 1; $day <= 7; $day++): ?>
                            <?php
                                ...
                                $isFrameDay = ($day == 7);
                            ?>
                            <div class="streak-day-box <?php echo e($isDone ? 'completed' : ($isCurrent ? 'current' : '')); ?> <?php echo e($isFrameDay && !$isDone && !$isCurrent ? 'special-day' : ''); ?>">
                                <div style="font-size: 0.64rem; font-weight: 600;">Ngày <?php echo e($day); ?></div>
                                <div class="my-1 d-flex align-items-center justify-content-center" style="height: 28px;">
                                    ...
                                    <?php elseif($isFrameDay): ?>
                                        <?php if($day7Frame && $day7Frame->image_url): ?>
                                            <img src="<?php echo e(asset($day7Frame->image_url)); ?>" alt="<?php echo e($day7Frame->name); ?>" style="width: 24px; height: 24px; object-fit: contain;" title="Phần thưởng: Khung <?php echo e($day7Frame->name); ?>">
                                        <?php else: ?>
                                            <span class="text-dark fw-bold" style="font-size: 0.68rem;">Khung</span>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('images/xu.png')); ?>" alt="xu" style="width: 16px; height: 16px; object-fit: contain;">
                                    <?php endif; ?>
                                </div>
                                <div class="fw-bold text-truncate" style="font-size: 0.65rem;">
                                    <?php if($isFrameDay): ?>
                                        <span class="<?php echo e($isDone ? 'text-muted' : 'special-day-title'); ?>"><?php echo e($day7Frame->name ?? 'Khung'); ?></span>
                                    <?php else: ?>
                                        +<?php echo e($day * 10); ?>
                    ...
                    <button id="btnDailyCheckinSide" class="btn btn-indigo w-100 fw-bold" style="padding: 9px; font-size: 0.84rem;" <?php if($user && $user->last_daily_bonus_at && \Carbon\Carbon::parse($user->last_daily_bonus_at)->isToday()): ?> disabled <?php endif; ?>>
                        <?php if($user && $user->last_daily_bonus_at && \Carbon\Carbon::parse($user->last_daily_bonus_at)->isToday()): ?>
                ...
                <div class="col-lg-8 col-xl-8">
                    ...
                    <div class="quest-progress-card-cream">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <h6 class="fw-extrabold text-dark mb-0" style="font-size: 0.88rem;">
                                Tiến độ tích xu: <span class="text-indigo fw-black"><?php echo e(number_format($totalPointsEarned)); ?> xu</span>
                            </h6>
                            <?php if($allClaimed): ?>
                        ...
                        <div class="quest-milestone-track-wrapper">
                            <div class="quest-milestone-line-bg">
                                <div class="quest-milestone-line-fill" style="width: <?php echo e($milestonePercent); ?>%; background: #475569;"></div>
                            </div>
                            ...
                            <div class="milestone-node">
                                    ...
                                    <div class="d-flex align-items-center gap-1">
                                        <?php if($frame100): ?>
                                            <div class="tooltip-mini-card">
                                                ...
                                                <img src="<?php echo e(asset($frame100->image_url)); ?>" alt="<?php echo e($frame100->name); ?>">
                                                <div class="tooltip-frame-name">Khung <?php echo e($frame100->name); ?></div>
                                            </div>
                                        <?php else: ?>
                                            <div class="tooltip-mini-card">
                                                <span class="tooltip-frame-caption">Phần thưởng</span>
                                ...
                                <?php elseif($totalPointsEarned >= 100): ?>
                                ...
                                <?php endif; ?>
                                <div class="node-bottom-val <?php echo e($totalPointsEarned >= 100 ? 'text-dark fw-extrabold' : 'text-muted'); ?>">100</div>
                            </div>
                            ...
                            <div class="milestone-node">
                                <div class="milestone-tooltip">
                                    <div class="d-flex align-items-center gap-1">
                                        <?php if($frame200): ?>
                                            <div class="tooltip-mini-card">
                                                <span class="tooltip-frame-caption">Phần thưởng</span>
                                                <img src="<?php echo e(asset($frame200->image_url)); ?>" alt="<?php echo e($frame200->name); ?>">
                                                <div class="tooltip-frame-name">Khung <?php echo e($frame200->name); ?></div>
                                            </div>
                                        <?php else: ?>
                                            <div class="tooltip-mini-card">
                                                <span class="tooltip-frame-caption">Phần thưởng</span>
                                ...
                                <?php elseif($totalPointsEarned >= 200): ?>
                                ...
                                <?php endif; ?>
                                <div class="node-bottom-val <?php echo e($totalPointsEarned >= 200 ? 'text-dark fw-extrabold' : 'text-muted'); ?>">200</div>
                            </div>
                            ...
                            <div class="milestone-node">
                                <div class="milestone-tooltip">
                                    <div class="d-flex align-items-center gap-1">
                                        <?php if($frame500): ?>
                                            <div class="tooltip-mini-card">
                                                <span class="tooltip-frame-caption">Phần thưởng</span>
                                                <img src="<?php echo e(asset($frame500->image_url)); ?>" alt="<?php echo e($frame500->name); ?>">
                                                <div class="tooltip-frame-name">Khung <?php echo e($frame500->name); ?></div>
                                            </div>
                                        <?php else: ?>
                                            <div class="tooltip-mini-card">
                                                <span class="tooltip-frame-caption">Phần thưởng</span>
                                ...
                                <?php elseif($totalPointsEarned >= 500): ?>
                                ...
                                <?php endif; ?>
                                <div class="node-bottom-val <?php echo e($totalPointsEarned >= 500 ? 'text-indigo fw-extrabold' : 'text-muted'); ?>">500</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main-section-card">
                        ...
                        <div id="questListContainer">
                            ...
                            ?>
                            <?php if($sessionMission): ?>
                            <div class="quest-item-card quest-unit" data-type="daily">
                                <div>
                                    <h6 class="fw-bold text-dark mb-1" style="font-size: 0.86rem;"><?php echo e($sessionMission->title); ?></h6>
                                    <div class="text-muted mb-1" style="font-size: 0.74rem;"><?php echo e($sessionMission->description ?: 'Online đủ thời gian rồi nhận thưởng nhiệm vụ.'); ?></div>
                                    <div class="d-flex align-items-center gap-2" style="width: 140px;">
                                        <div class="progress flex-grow-1 rounded-pill" style="height: 4px; background: #e2e8f0;">
                                            <div class="progress-bar bg-primary" id="missionSessionProgressBar" style="width: <?php echo e($sessionPercent); ?>%;" aria-valuenow="<?php echo e($sessionMinutes); ?>"></div>
                                        </div>
                                        <span class="text-muted fw-semibold" id="missionSessionProgressText" style="font-size: 0.68rem;"><?php echo e(min($sessionMinutes, $sessionTarget)); ?>/<?php echo e($sessionTarget); ?> phút</span>
                                    </div>
                                </div>
                                <div class="quest-reward-tag">
                                    <?php if($sessionMission->reward_points > 0): ?>
                                        +<?php echo e($sessionMission->reward_points); ?> <img src="<?php echo e(asset('images/xu.png')); ?>" alt="xu" style="width: 15px; height: 15px; object-fit: contain; vertical-align: -2px;" class="ms-0.5">
                                    <?php else: ?>
                                        <span class="text-muted" style="font-size:0.72rem;">Theo dõi</span>
                                    <?php endif; ?>
                                </div>
                                    <div>
                                        <?php if($sessionClaimed): ?>
                                    ...
                                    <?php elseif($sessionCompleted): ?>
                                        <button class="btn-quest-claim btn-claim-mission" data-id="<?php echo e($sessionMission->id); ?>">Nhận thưởng</button>
                                    <?php else: ?>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $dailyMissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php if($mission->action_key === 'daily_login' || $mission->action_key === 'active_session' || str_contains(mb_strtolower($mission->title), 'điểm danh')): ?>
                                    <?php continue; ?>
                                <?php endif; ?>
                                <?php
                                ...
                                <div class="quest-item-card quest-unit" data-type="daily">
                                    <div>
                                        <h6 class="fw-bold text-dark mb-1" style="font-size: 0.86rem;"><?php echo e($mission->title); ?></h6>
                                        <div class="text-muted mb-1" style="font-size: 0.74rem;"><?php echo e($mission->description); ?></div>
                                        <div class="d-flex align-items-center gap-2" style="width: 130px;">
                                            ...
                                            <span class="text-muted fw-semibold" style="font-size: 0.68rem;"><?php echo e($currentProgress); ?>/<?php echo e($mission->target_count); ?></span>
                                        </div>
                                    </div>
                                    <div class="quest-reward-tag">
                                        <?php if($mission->reward_points > 0): ?>
                                            +<?php echo e($mission->reward_points); ?> <img src="<?php echo e(asset('images/xu.png')); ?>" alt="xu" style="width: 15px; height: 15px; object-fit: contain; vertical-align: -2px;" class="ms-0.5">
                                        <?php else: ?>
                                    ...
                                    <div>
                                        ...
                                        <?php elseif($isCompleted): ?>
                                            <button class="btn-quest-claim btn-claim-mission" data-id="<?php echo e($mission->id); ?>">Nhận thưởng</button>
                                        <?php else: ?>
                                            <a href="<?php echo e(url('/')); ?>" class="btn-quest-action text-decoration-none d-inline-block">Đến ngay</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            ...
                            <?php $otherMissions = $weeklyMissions->concat($achievementMissions); ?>
                            <?php $__currentLoopData = $otherMissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($mission->action_key === 'daily_login' || $mission->action_key === 'active_session'): ?>
                                    <?php continue; ?>
                                <?php endif; ?>
                                <?php
                                    $um = $userMissions->get($mission->id);
                                    ...
                                    $percent = min(100, round(($currentProgress / max(1, $mission->target_count)) * 100));
                                ?>
                                <div class="quest-item-card quest-unit" data-type="<?php echo e($mission->type); ?>">
                                    <div>
                                        <h6 class="fw-bold text-dark mb-1" style="font-size: 0.86rem;"><?php echo e($mission->title); ?></h6>
                                        <div class="text-muted mb-1" style="font-size: 0.74rem;"><?php echo e($mission->description); ?></div>
                                        <span class="badge px-2 py-0.5 rounded-pill" style="font-size: 0.68rem; background: #f1f5f9; color: #475569;">
                                            <?php echo e($mission->type === 'weekly' ? 'Hàng tuần' : 'Thành tựu'); ?>
                ...
                <div class="col-lg-4 col-xl-4">
                    ...
                    <div class="widget-card" id="dailySummaryWidget">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <span class="badge bg-light text-muted fw-semibold" style="font-size: 0.68rem;" title="Thời gian còn lại đến khi reset nhiệm vụ ngày">
                                <span id="dailyResetCountdown" data-seconds="<?php echo e($secondsToMidnight); ?>">--:--:--</span>
                            </span>
                        </div>
                        <div class="d-flex align-items-center gap-3">
                            <div class="circle-progress-box" style="<?php echo e($dailyPercent >= 100 ? 'border-color:#166534;color:#166534;background:#f0fdf4;' : ''); ?>">
                                <span id="dailySummaryCount"><?php echo e($dailyDone); ?>/<?php echo e(max(1, $dailyTotal)); ?></span>
                            </div>
                            <div class="flex-grow-1">
                                ...
                                <?php elseif($dailyDone >= $dailyTotal): ?>
                                    ...
                                    <div class="text-muted mb-1.5" style="font-size: 0.74rem;">
                                        <?php if($dailyClaimable > 0): ?>
                                            Còn <?php echo e($dailyClaimable); ?> phần thưởng chưa nhận — bấm “Nhận thưởng” bên trái.
                                        <?php else: ?>
                                            Reset sau <span class="daily-reset-hint">00:00</span> ngày mai.
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
                                    <div class="fw-bold text-dark" style="font-size: 0.82rem;">Hoàn thành <?php echo e($dailyTotal); ?> nhiệm vụ ngày</div>
                                    <div class="text-muted mb-1.5" style="font-size: 0.74rem;">
                                        Tổng thưởng ngày tới
                                        <strong class="text-dark"><?php echo e(number_format($dailyRewardSum)); ?> xu
                                            <img src="<?php echo e(asset('images/xu.png')); ?>" alt="xu" style="width: 15px; height: 15px; object-fit: contain; vertical-align: -2px;" class="ms-0.5">
                                        </strong>
                                    </div>
                                <?php endif; ?>
                                <div class="progress rounded-pill" style="height: 5px; width: 100%; max-width: 160px; background: #e2e8f0;">
                                    <div class="progress-bar" id="dailySummaryBar" style="width: <?php echo e($dailyPercent); ?>%; background: <?php echo e($dailyPercent >= 100 ? '#000000' : '#000000'); ?>;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="widget-card">
                        ...
                        <div class="d-flex flex-column gap-1">
                            <?php $__empty_1 = true; $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $topUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php $rank = $index + 1; ?>
                                <div class="leaderboard-row <?php echo e($user && $topUser->id == $user->id ? 'highlight' : ''); ?>">
                                    <div class="d-flex align-items-center gap-2">
                                        <div class="rank-badge <?php echo e($rank == 1 ? 'rank-1' : ($rank == 2 ? 'rank-2' : ($rank == 3 ? 'rank-3' : 'rank-other'))); ?>">
                                            <?php echo e($rank); ?>

                                        </div>
                                        <?php if (isset($component)) { $__componentOriginalaa6ddd3b8ee0acee5a2d1d7ac5c7e40e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaa6ddd3b8ee0acee5a2d1d7ac5c7e40e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-avatar','data' => ['user' => $topUser,'size' => '26']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('user-avatar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($topUser),'size' => '26']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalaa6ddd3b8ee0acee5a2d1d7ac5c7e40e)): ?>
<?php $attributes = $__attributesOriginalaa6ddd3b8ee0acee5a2d1d7ac5c7e40e; ?>
...
<?php unset($__componentOriginalaa6ddd3b8ee0acee5a2d1d7ac5c7e40e); ?>
<?php endif; ?>
                                        <span class="text-dark small text-truncate" style="max-width: 110px;"><?php echo e($topUser->display_name ?? $topUser->username); ?></span>
                                    </div>
                                    <div class="fw-bold text-dark" style="font-size: 0.8rem;">
                                        <?php echo e(number_format($topUser->points)); ?> <img src="<?php echo e(asset('images/xu.png')); ?>" alt="xu" style="width: 14px; height: 14px; object-fit: contain; vertical-align: -2px;" class="ms-0.5">
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <?php endif; ?>
        ...
        <div class="tab-pane fade" id="inventory-pane" role="tabpanel">
            <div class="ms-section-head">
                ...
                <?php if($user && $user->equipped_frame_id): ?>
            ...
            <div class="main-section-card">
                <div class="row g-3">
                            <?php $myFrames = $allFrames->whereIn('id', $unlockedFrameIds); ?>
                            <?php $__empty_1 = true; $__currentLoopData = $myFrames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $frame): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php $isEquipped = ($user && $user->equipped_frame_id == $frame->id); ?>
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="p-3 border text-center bg-white" style="border-radius: 2px;">
                                        <div class="avatar-frame-wrapper <?php echo e($frame->image_url ? 'has-png-frame' : $frame->css_style); ?> mx-auto mb-2" style="width: 56px; height: 56px;">
                                            <img src="<?php echo e($user ? $user->avatar_formatted_url : 'https://ui-avatars.com/api/?name=Guest&background=6366f1&color=fff'); ?>" onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name=Guest&background=6366f1&color=fff';" style="width: 100%; height: 100%; border-radius: 50%; object-fit: cover;">
                                            <?php if($frame->image_url): ?>
                                                <img src="<?php echo e(asset($frame->image_url)); ?>" class="avatar-frame-png-overlay">
                                            <?php endif; ?>
                                        </div>
                                        <h6 class="fw-bold text-dark text-truncate mb-1" style="font-size: 0.86rem;"><?php echo e($frame->name); ?></h6>
                                        <div class="text-muted text-truncate small mb-2" style="font-size: 0.75rem;"><?php echo e($frame->description); ?></div>
                                        <?php if($isEquipped): ?>
                                            <button class="btn btn-secondary btn-sm w-100 fw-bold rounded-pill" disabled style="font-size: 0.78rem;">Đang đeo</button>
                                        <?php else: ?>
                                            <button class="btn btn-indigo btn-sm w-100 btn-equip-frame" data-id="<?php echo e($frame->id); ?>" style="font-size: 0.78rem;">Trang bị</button>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="reward-item-card d-none" id="cardAvatarFrame">
                    ...
                    <div class="reward-card-preview">
                        <div class="reward-avatar-preview-box">
                            <img src="<?php echo e($user ? $user->avatar_formatted_url : 'https://ui-avatars.com/api/?name=Guest&background=6366f1&color=fff'); ?>" class="reward-avatar-img">
                ...
                <div class="reward-item-card" id="cardCoinsReward">
                    <div class="reward-card-preview">
                        <div class="coin-card-icon-box">
                            <img src="<?php echo e(asset('images/xu.png')); ?>" alt="xu" style="width: 42px; height: 42px; object-fit: contain;">
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.equipRewardFrame = function() {
        ...
        fetch("<?php echo e(route('client.avatar_frames.equip')); ?>", {
            method: "POST",
            headers: {
    ...
    document.querySelectorAll('.btn-claim-milestone-box').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            fetch("<?php echo e(route('client.missions.claim_milestone')); ?>", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "X-CSRF-TOKEN": csrfToken
...
window.redeemReward = function(rewardId, btn) {
    ...
    fetch("<?php echo e(url('/rewards/redeem')); ?>/" + rewardId, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/client/missions/index.blade.php ENDPATH**/ ?>