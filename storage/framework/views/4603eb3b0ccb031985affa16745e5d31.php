...
<head>
    ...
    <style>
        ...
        * {
        ...
        .split-image-side {
            flex: 1;
            background: url('<?php echo e(asset('images/nen02.png')); ?>') no-repeat center center;
...
<body>
    <div class="split-container">
        ...
        <div class="split-form-side">
            <a href="<?php echo e(route('home')); ?>" class="top-back-link">
...
unset($__errorArgs, $__bag); ?>" placeholder="Tên đăng nhập" value="<?php echo e(old('username')); ?>" autofocus>
                            </div>
                            <span class="field-error-msg" id="usernameError"><?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" placeholder="Email của bạn" value="<?php echo e(old('email')); ?>">
                            </div>
                            <span class="field-error-msg" id="emailError"><?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?><?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="display_name" name="display_name" class="form-control <?php $__errorArgs = ['display_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Tên hiển thị trên bản đồ" value="<?php echo e(old('display_name')); ?>">
                        </div>
                        <span class="field-error-msg" id="displayNameError"><?php $__errorArgs = ['display_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?><?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="form-row">
                        <div class="form-group col-half">
                            ...
                            <div class="input-wrapper">
                                <input type="password" id="password" name="password" class="form-control has-right-icon <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Tối thiểu 6 ký tự">
                            ...
                            <span class="field-error-msg" id="passwordError"><?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><?php echo e($message); ?><?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                ...
                <div class="auth-footer">
                    <div>Đã có tài khoản? <a href="<?php echo e(route('login')); ?>">Đăng nhập</a></div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/client/auth/register.blade.php ENDPATH**/ ?>