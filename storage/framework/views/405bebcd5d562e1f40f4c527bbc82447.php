...
<div class="card-minimal mx-auto p-4" style="max-width: 720px;">
    <form action="<?php echo e(route('admin.categories.update', $category->id)); ?>" method="POST" enctype="multipart/form-data" novalidate>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name', $category->name)); ?>" style="border-color: #e2e8f0;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control form-control-sm" id="description" name="description" rows="3" style="border-color: #e2e8f0;"><?php echo e(old('description', $category->description)); ?></textarea>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-9">
                ...
                <?php if($category->icon): ?>
                    <div class="mb-2">
                        <img src="<?php echo e(asset($category->icon)); ?>" alt="Icon" style="height: 32px; width: auto; object-fit: contain;">
                    </div>
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" id="icon_color" name="icon_color" value="<?php echo e(old('icon_color', $category->icon_color ?? '#ef4444')); ?>" title="Chọn màu cho ghim" style="border-color: #e2e8f0; height: 31px;">
...
unset($__errorArgs, $__bag); ?>" id="display_order" name="display_order" value="<?php echo e(old('display_order', $category->display_order)); ?>" style="border-color: #e2e8f0;">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>