    ...
    <div class="container py-4">
        ...
        <nav aria-label="breadcrumb" class="mb-3">
            <ol class="breadcrumb mb-0" style="font-size: 0.8rem;">
                <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>" class="text-decoration-none" style="color: #71717a;">Trang chủ</a></li>
                <li class="breadcrumb-item"><a href="<?php echo e(route('client.news.index')); ?>" class="text-decoration-none" style="color: #71717a;">Tin tức</a></li>
                <li class="breadcrumb-item active" style="color: #27272a;" aria-current="page"><?php echo e(Str::limit($news->title, 45)); ?></li>
            </ol>
        </nav>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8 pe-lg-4">
                <article class="bg-white p-2 p-md-3">
                    <div class="mb-2">
                        <span class="text-uppercase fw-semibold" style="font-size: 0.75rem; color: #71717a; letter-spacing: 0.04em;"><?php echo e($news->type_label); ?></span>
                    </div>
                    ...
                    <div class="article-meta mb-4 pb-3 border-bottom d-flex align-items-center gap-3" style="font-size: 0.775rem; color: #a1a1aa; border-color: #f4f4f5 !important;">
                        <span><?php echo e($news->published_at ? $news->published_at->format('d/m/Y H:i') : $news->created_at->format('d/m/Y H:i')); ?></span>
                        <span>&bull;</span>
                        <span><?php echo e(number_format($news->view_count)); ?> lượt xem</span>
                    </div>

                    <!-- Featured Image -->
                    <?php if($news->featured_image_url): ?>
                        <div class="mb-4">
                    ...
                    <div class="article-content-body" style="font-size: 1rem; line-height: 1.75; color: #3f3f46; font-weight: 400;">
                        <?php echo \App\Models\News::rewriteContentImageUrls($news->content); ?>
                        ...
                        <div class="related-list d-flex flex-column gap-3">
                            <?php $__empty_1 = true; $__currentLoopData = $relatedNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <article class="related-item">
                                    <a href="<?php echo e(route('client.news.show', $item->slug)); ?>" class="text-decoration-none group-news-link d-flex gap-3 align-items-start">
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/client/news/show.blade.php ENDPATH**/ ?>