<!DOCTYPE html>
<html>
<?php $hasPanorama = $location->panoramas()->exists(); ?>
<head>
    <title><?php echo e(($hasPanorama ? 'Khám phá 360°' : 'Khám phá')); ?> - <?php echo e($location->name); ?></title>
    <meta charset="utf-8">
...
<body>
    ...
    <a href="<?php echo e(route('home')); ?>" class="btn-back-map">
    ...
    <div class="viewer-more-menu" id="viewerMoreMenu">
        ...
        <div class="viewer-more-dropdown" id="viewerMoreDropdown">
            ...
            <button type="button" class="viewer-more-item" onclick="openReportModal(<?php echo e($location->id); ?>, 'Location'); closeViewerMoreMenu();">Báo cáo</button>
            <button type="button" class="viewer-more-item" onclick="openFeedbackModal(<?php echo e($location->id); ?>); closeViewerMoreMenu();">Góp ý / báo lỗi</button>
        </div>
    </div>

    <!-- Bottom dock: Lưu / Bình luận / Ảnh / Âm thanh -->
    <?php echo $__env->make('client.partials.location-viewer-dock', [
        'location' => $location,
        ...
        <div class="comments-list" id="commentsList">
            ...
            <div class="rating-overview-card">
                <div class="rating-score-box">
                    <div class="rating-score-num"><?php echo e(number_format($avgRating, 1)); ?></div>
                    <div class="rating-score-stars">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <i class="<?php echo e($i <= round($avgRating) ? 'fa-solid' : 'fa-regular'); ?> fa-star"></i>
                        <?php endfor; ?>
                    </div>
                    <div class="rating-score-count"><?php echo e($totalComments); ?> đánh giá</div>
                </div>
                <div class="rating-bars-box">
                    <?php $__currentLoopData = [5, 4, 3, 2, 1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $star): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="rating-bar-row">
                            <span class="star-num"><?php echo e($star); ?> <i class="fa-solid fa-star"></i></span>
                            <div class="rating-bar-bg">
                                <div class="rating-bar-fill" style="width: <?php echo e($percent); ?>%;"></div>
                            </div>
                            <span class="star-count"><?php echo e($starCount); ?></span>
                        </div>
            ...
            <div id="commentsItemsWrapper">
                <?php $__empty_1 = true; $__currentLoopData = $location->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <div class="gmaps-review-card" id="comment-<?php echo e($comment->id); ?>" data-rating="<?php echo e($comment->rating ?? 5); ?>" data-timestamp="<?php echo e($comment->created_at->timestamp); ?>">
                        <!-- Header -->
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-avatar','data' => ['user' => $comment->user,'size' => '42']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($comment->user),'size' => '42']); ?>
...
<?php endif; ?>
                                <div>
                                    <div class="gmaps-username"><?php echo e(optional($comment->user)->display_name ?? optional($comment->user)->username ?? 'Thành viên'); ?></div>
                                    <div class="gmaps-user-subtitle">Thành viên · <?php echo e($userCommentsCount); ?> đánh giá</div>
                                </div>
                            </div>
                            
                            <!-- 3-Dots Menu -->
                            <div class="gmaps-more-wrapper">
                                <button class="gmaps-btn-more" onclick="toggleGmapsMenu(event, <?php echo e($comment->id); ?>)" title="Tùy chọn">
                                    <i class="fa-solid fa-ellipsis-vertical"></i>
                                </button>
                                <div class="gmaps-dropdown-menu" id="gmapsMenu-<?php echo e($comment->id); ?>">
                                    <?php if(Auth::check() && Auth::id() === $comment->user_id): ?>
                                        <div class="gmaps-dropdown-item" onclick="event.stopPropagation(); openEditReviewModal(<?php echo e($comment->id); ?>, <?php echo e($comment->rating); ?>, <?php echo e(json_encode($comment->content)); ?>)">
                                            Chỉnh sửa
                                        </div>
                                        <div class="gmaps-dropdown-item text-danger" onclick="event.stopPropagation(); deleteUserComment(<?php echo e($comment->id); ?>)">
                                            Xóa
                                        </div>
                                    <?php else: ?>
                                        <div class="gmaps-dropdown-item" onclick="shareCommentLink(event, <?php echo e($comment->id); ?>)">
                                            Chia sẻ
                                        </div>
                                        <div class="gmaps-dropdown-item text-danger" onclick="openReportModal(<?php echo e($comment->id); ?>, 'Comment')">
                                            Báo cáo
                                        </div>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="gmaps-rating-row">
                            <?php if($comment->rating && $comment->rating > 0): ?>
                                <div class="gmaps-stars">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <i class="<?php echo e($i <= $comment->rating ? 'fa-solid' : 'fa-regular'); ?> fa-star"></i>
                                    <?php endfor; ?>
                                </div>
                            <?php endif; ?>
                            <span class="gmaps-date">Thời gian: <?php echo e($comment->created_at->diffForHumans()); ?></span>
                        </div>

                        <!-- Body -->
                        <div class="gmaps-review-body">
                            <?php if($isLong): ?>
                                <span class="gmaps-text-short"><?php echo e(mb_substr($content, 0, 150)); ?>...</span>
                                <span class="gmaps-text-full" style="display: none;"><?php echo e($content); ?></span>
                        ...
                        <?php if($ownerReply): ?>
                            <div class="gmaps-owner-reply">
                                ...
                                <p class="gmaps-owner-reply__text"><?php echo e($ownerReply->content); ?></p>
                            </div>
                        <?php endif; ?>

                        <!-- Footer Actions -->
                        <div class="gmaps-review-footer">
                            <button class="gmaps-action-btn btn-like-gmaps" onclick="toggleLikeGmaps(this, <?php echo e($comment->id); ?>)">
                                <i class="fa-regular fa-thumbs-up"></i>
                                <span class="like-label">Thích</span>
                            </button>
                            <button class="gmaps-action-btn" onclick="shareCommentLink(event, <?php echo e($comment->id); ?>)">
                ...
                <div class="d-flex align-items-center justify-content-between py-1">
                    ...
                    <div class="d-flex align-items-center" style="gap: 8px;">
                        <span class="gmaps-stars" style="font-size: 13px;">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <i class="<?php echo e($i <= $userComment->rating ? 'fa-solid' : 'fa-regular'); ?> fa-star"></i>
                            <?php endfor; ?>
                        </span>
                        <button class="btn-goto-my-review" onclick="scrollToMyReview(<?php echo e($userComment->id); ?>)">Xem</button>
                    </div>
                </div>
            <?php else: ?>
    ...
    <div class="write-review-overlay" id="writeReviewModalOverlay">
        <div class="write-review-modal">
            ...
            <div class="write-review-header">
                <h3 class="location-name-title" id="modalWriteReviewTitle"><?php echo e($location->name); ?></h3>
            ...
            <div class="write-review-body">
                ...
                <div class="review-user-box">
                    <?php if(auth()->guard()->check()): ?>
                        <?php if (isset($component)) { $__componentOriginalaa6ddd3b8ee0acee5a2d1d7ac5c7e40e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaa6ddd3b8ee0acee5a2d1d7ac5c7e40e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-avatar','data' => ['user' => Auth::user(),'size' => '40']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('user-avatar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(Auth::user()),'size' => '40']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalaa6ddd3b8ee0acee5a2d1d7ac5c7e40e)): ?>
<?php $attributes = $__attributesOriginalaa6ddd3b8ee0acee5a2d1d7ac5c7e40e; ?>
...
<?php endif; ?>
                        <div>
                            <div class="user-display-name"><?php echo e(Auth::user()->display_name ?? Auth::user()->username); ?></div>
    ...
    <div class="viewer-area">
        <?php if($photoMode): ?>
            <?php echo $__env->make('client.partials.location-photo-viewer', [
                'location' => $location,
                'photoSlides' => $photoSlides,
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
        ...
        <div class="audio-player visible" id="audioPlayer">
            <div class="audio-info-popover" id="audioInfoPopover">
                ...
                <div class="audio-popover-body">
                    <?php echo nl2br(e($audioNarrationText)); ?>
            ...
            <div class="audio-mascot-wrapper">
                ...
                <img src="<?php echo e(asset('images/loax.png')); ?>"
                     alt="Thuyết minh"
    ...
    (function() {
        ...
        const loaOnSrc = <?php echo json_encode(asset('images/loa.png'), 15, 512) ?>;
        const loaOffSrc = <?php echo json_encode(asset('images/loax.png'), 15, 512) ?>;
        const audioUrl = <?php echo json_encode($location->audio_url ? asset('storage/' . $location->audio_url) : null, 15, 512) ?>;
        const narrationText = <?php echo json_encode(trim(strip_tags((string) data_get($location->attributes, 'tts_text', '')))) ?>;
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            starBtns.forEach(star => {
                star.addEventListener('click', function() {
                    if (!isAuth) {
                        ...
                        setTimeout(() => { window.location.href = "<?php echo e(route('login')); ?>"; }, 1200);
                        return;
                    }
        ...
        window.openWriteReviewModal = function(initialRating = 5) {
            ...
            if (modal) {
                ...
                if (titleEl) titleEl.innerText = "<?php echo e($location->name); ?>";
    ...
    function shareLocation() {
        ...
        const title = <?php echo json_encode($location->name, 15, 512) ?>;
        closeViewerMoreMenu();
    ...
    function submitFeedback() {
        ...
        fetch("<?php echo e(route('client.feedback.submit')); ?>", {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrfToken,
                'Accept': 'application/json',
...
(function() {
    ...
    const commentsData = <?php echo json_encode($floatingComments, 15, 512) ?>;
    ...
    function renderFloatingAvatar(item) {
        ...
        return `<div class="avatar-frame-wrapper ${escapeHtml(frameClass)}" style="width:30px;height:30px;flex-shrink:0;" title="${name}">
            <img src="${avatar}" alt="${name}" onerror="this.onerror=null;this.src='<?php echo e(asset('images/default-avatar.png')); ?>';">
            ${overlay}
        </div>`;
    }
...
<?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/client/360.blade.php ENDPATH**/ ?>