...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Cổng Thông Tin Du Lịch Ninh Bình'); ?></title>
    <!-- Google Fonts -->
...
<body class="<?php echo $__env->yieldContent('body_class'); ?>">
    <header class="site-header navbar navbar-expand-lg <?php echo $__env->yieldContent('header_variant'); ?>">
        <div class="container">
            <div class="site-header__inner">
                <a class="site-brand" href="<?php echo e(route('client.landing')); ?>">
                    <img class="site-brand__logo" src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo Du lịch Ninh Bình">
                ...
                <div class="collapse navbar-collapse flex-grow-1" id="siteNavCollapse">
                    <nav class="site-nav" aria-label="Điều hướng chính">
                        <a class="site-nav__link <?php echo e(request()->routeIs('client.landing') ? 'is-active' : ''); ?>" href="<?php echo e(route('client.landing')); ?>">Trang chủ</a>
                        <a class="site-nav__link <?php echo e(request()->routeIs('client.about') ? 'is-active' : ''); ?>" href="<?php echo e(route('client.about')); ?>">Giới thiệu</a>
                        <a class="site-nav__link <?php echo e(request()->routeIs('client.events.*') || request()->routeIs('client.news.*') ? 'is-active' : ''); ?>" href="<?php echo e(route('client.events.index')); ?>">Tin tức</a>
                        <a class="site-nav__link <?php echo e(request()->routeIs('client.pano_service') ? 'is-active' : ''); ?>" href="<?php echo e(route('client.pano_service')); ?>">Dịch vụ</a>
                        <a class="site-nav__link <?php echo e(request()->routeIs('home') ? 'is-active' : ''); ?>" href="<?php echo e(route('home')); ?>">Bản đồ</a>
                    </nav>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="container">
            <div class="row g-4">
                <div class="col-md-5">
                    <a class="footer-brand mb-2" href="<?php echo e(route('client.landing')); ?>">
                        <img class="footer-brand__logo" src="<?php echo e(asset('images/logo.png')); ?>" alt="" aria-hidden="true">
                ...
                <div class="col-6 col-md-3">
                    ...
                    <ul class="footer-links">
                        <li><a href="<?php echo e(route('client.landing')); ?>">Trang chủ</a></li>
                        <li><a href="<?php echo e(route('home')); ?>">Bản đồ du lịch</a></li>
                        <li><a href="<?php echo e(route('client.about')); ?>">Giới thiệu</a></li>
                        <li><a href="<?php echo e(route('client.events.index')); ?>">Tin tức</a></li>
                        <li><a href="<?php echo e(route('client.pano_service')); ?>">Dịch vụ tour 360</a></li>
                    </ul>
                </div>
                <div class="col-6 col-md-4">
                    ...
                    <ul class="footer-links">
                        <?php if(auth()->guard()->check()): ?>
                            <li><a href="<?php echo e(route('client.profile')); ?>">Trang cá nhân</a></li>
                            <li><a href="<?php echo e(route('client.favorites.index')); ?>">Địa điểm yêu thích</a></li>
                        <?php else: ?>
            ...
            <div class="footer-bottom text-center text-md-start">
                &copy; <?php echo e(date('Y')); ?> Cổng Thông Tin Du Lịch Ninh Bình
            </div>
        </div>
    </footer>
...
<?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/client/layouts/app.blade.php ENDPATH**/ ?>