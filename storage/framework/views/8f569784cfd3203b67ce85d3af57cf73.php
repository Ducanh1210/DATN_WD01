...
<div class="top-navbar">
    <div class="nav-left">
        <a href="<?php echo e(route('client.profile')); ?>" class="nav-back" title="Quay lại trang cá nhân"><i class="bi bi-chevron-left"></i></a>
    ...
    <div class="nav-right">
        <a href="<?php echo e(route('client.pano_service')); ?>" class="nav-help" target="_blank" rel="noopener">Trợ giúp</a>
        <span class="nav-user-email"><?php echo e(Auth::user()->email ?? ''); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user-avatar','data' => ['user' => Auth::user(),'size' => '30']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(Auth::user()),'size' => '30']); ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (bizForm) {
            ...
            const bizSuggestUrl = <?php echo json_encode(route('client.profile.business.locations.suggest'), 15, 512) ?>;
            ...
            const BIZ_USER_ID = <?php echo e((int) auth()->id()); ?>;
            ...
            function setupAvatarUploader() {
                ...
                function handleAvatarFile(file) {
                    ...
                    formData.append('file', file);
                    formData.append('_token', '<?php echo e(csrf_token()); ?>');
                    fetch("<?php echo e(route('client.profile.business.upload_photo')); ?>", { method: 'POST', body: formData })
                        .then(res => res.json())
                        .then(data => {
                            if (data.success) {
...
<?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/client/business_upgrade.blade.php ENDPATH**/ ?>