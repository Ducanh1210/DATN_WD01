...
?>
<?php if($callPhone || $zaloUrl || $fbUrl): ?>
<div class="viewer-contact" id="viewerContactWrap">
    <div class="viewer-contact-sheet" id="viewerContactMenu" hidden>
        <?php if($callPhone): ?>
            <a href="tel:<?php echo e($callPhone); ?>" class="viewer-contact-sheet__item viewer-contact-sheet__item--call">
                ...
                <span class="viewer-contact-sheet__copy">
                    ...
                    <span class="viewer-contact-sheet__hint"><?php echo e($callPhoneDisplay); ?></span>
                </span>
            </a>
        <?php endif; ?>
        <?php if($zaloUrl): ?>
            <a href="<?php echo e($zaloUrl); ?>" class="viewer-contact-sheet__item viewer-contact-sheet__item--zalo" target="_blank" rel="noopener">
        ...
        <?php endif; ?>
        <?php if($fbUrl): ?>
            <a href="<?php echo e($fbUrl); ?>" class="viewer-contact-sheet__item viewer-contact-sheet__item--fb" target="_blank" rel="noopener">
...
<div class="viewer-dock" id="viewerDock">
    <button type="button" class="viewer-dock__btn <?php echo e($isFavorited ? 'is-active' : ''); ?>" id="btnToggleFavorite" title="Lưu">
    ...
    <button type="button" class="viewer-dock__btn" id="btnToggleComments" title="Bình luận">
        <span class="viewer-dock__icon-wrap">
            ...
            <span class="viewer-dock__badge" id="commentsCountBadge"><?php echo e($location->comments->count()); ?></span>
        </span>
...
<script>
(function () {
    const slides = <?php echo json_encode($photoSlides, 15, 512) ?>;
    const locationName = <?php echo json_encode($location->name, 15, 512) ?>;
    const isPhotoMode = <?php echo json_encode((bool) $photoMode, 15, 512) ?>;
...
<?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/client/partials/location-viewer-dock.blade.php ENDPATH**/ ?>