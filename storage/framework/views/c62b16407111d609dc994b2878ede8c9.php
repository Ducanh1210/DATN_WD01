...
<div id="chatbot-widget">
    ...
    <button id="chatbot-toggle" title="Trợ lý ảo Ninh Bình">
        <img src="<?php echo e(asset('images/bot.png')); ?>" alt="Bot Icon" class="toggle-img">
        ...
        <div id="chatbot-header">
            <div class="chatbot-brand">
                <div class="chatbot-avatar">
                    <img src="<?php echo e(asset('images/bot.png')); ?>" alt="Bot Avatar">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function sendMessage() {
            ...
            fetch('<?php echo e(route("client.chat.message")); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH D:\laragon\www\datnv2\DuAn_TN\resources\views/components/chatbot-widget.blade.php ENDPATH**/ ?>