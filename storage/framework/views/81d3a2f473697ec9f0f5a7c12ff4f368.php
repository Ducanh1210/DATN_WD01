<?php $__env->startSection('title', 'Dịch vụ tour 360 | Ninh Bình Travel Hub'); ?>
            ...
            <div class="nb-split">
                <div>
                    ...
                    <div style="display:flex;flex-wrap:wrap;gap:12px;margin-top:28px;">
                        ...
                        <?php if($demoUrl): ?>
                            <a href="<?php echo e($demoUrl); ?>" target="_blank" rel="noopener" class="nb-btn nb-btn--outline">
                                Xem demo
                                <i class="fa-solid fa-arrow-right" aria-hidden="true"></i>
                            </a>
                        <?php endif; ?>
                ...
                <div class="nb-split__figure">
                    <img src="<?php echo e($sideImage); ?>"
                         alt="<?php echo e($demoLocation->name ?? 'Demo tour 360'); ?>"
                         loading="lazy"
        ...
        <div class="nb-wrap">
            <div class="nb-split nb-split--reverse">
                <div>
                    ...
                    <?php if($demoUrl): ?>
                        <a href="<?php echo e($demoUrl); ?>" target="_blank" rel="noopener" class="nb-link" style="margin-top: 28px;">
                            Xem demo <?php echo e(\Illuminate\Support\Str::limit($demoLocation->name ?? 'tour 360', 24)); ?>
                ...
                <div class="nb-split__figure">
                    <img src="<?php echo e(asset('images/trangtri2.jpg')); ?>"
    ...
    <section class="nb-section nb-section--tight">
        <div class="nb-wrap">
            <?php if(session('success')): ?>
                <div class="ps-alert ps-alert-ok mb-4" style="max-width:640px;margin-left:auto;margin-right:auto;text-align:center;"><?php echo e(session('success')); ?></div>
            <?php endif; ?>
...
<div class="modal fade" id="panoRequestModal" tabindex="-1" aria-labelledby="panoRequestModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0">
            ...
            <form action="<?php echo e(route('client.pano_service.submit')); ?>" method="POST" class="ps-form">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="from" value="public">

                <div class="modal-body px-4 pb-2 pt-3">
                    <?php if(session('error')): ?>
                        <div class="ps-alert ps-alert-err"><?php echo e(session('error')); ?></div>
                    <?php endif; ?>
                    <?php if($errors->any()): ?>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input
                                ...
                                required
                                maxlength="120"
                                value="<?php echo e(old('contact_name', $defaultContact)); ?>"
                        ...
                        <div class="col-md-6">
                            ...
                            <input
                                ...
                                required
                                maxlength="30"
                                value="<?php echo e(old('phone', $defaultPhone)); ?>"
                                placeholder="09xx..."
                                autocomplete="tel"
                            >
                        </div>
                        <div class="col-md-6">
                            ...
                            <input
                                ...
                                required
                                maxlength="180"
                                value="<?php echo e(old('place_name', $defaultPlace)); ?>"
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="pano_place_type" name="place_type" class="ps-field">
                                ...
                                <?php $__currentLoopData = $panoTypeLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php if(old('place_type') === $key): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select id="pano_scene_estimate" name="scene_estimate" class="ps-field">
                                ...
                                <?php $__currentLoopData = $panoSceneLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php if(old('scene_estimate') === $key): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="col-12">
...
<?php echo $__env->make('client.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/client/pano-service.blade.php ENDPATH**/ ?>