    ...
    <div class="custom-modal-card">
        ...
        <div class="custom-modal-body">
            ...
            <div style="text-align: center; padding: 20px 8px;">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn-contrib-submit" style="text-decoration: none; display: inline-block;">Đăng nhập ngay</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
...
function submitLocationSuggestion(e) {
    ...
    fetch('<?php echo e(route('client.locations.suggest')); ?>', {
        method: 'POST',
        body: formData,
        headers: {
...
<?php /**PATH D:\laragon\www\datnv2\DuAn_TN\resources\views/client/components/contribution-modals.blade.php ENDPATH**/ ?>