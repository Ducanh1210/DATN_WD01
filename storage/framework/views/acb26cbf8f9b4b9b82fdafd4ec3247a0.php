...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - Ninh Bình Travel Hub</title>
    <!-- Google Fonts -->
    ...
    <div class="d-flex">
        ...
        <div class="sidebar flex-shrink-0" id="sidebar">
            ...
            <nav>
                ...
                <a href="<?php echo e(route('admin.business-profiles.index')); ?>" class="d-flex justify-content-between align-items-center <?php echo e(request()->routeIs('admin.business-profiles.*') ? 'active' : ''); ?>">
                    ...
                    <?php if($pendingBizCount > 0): ?>
                        <span class="badge-count"><?php echo e($pendingBizCount); ?></span>
                    <?php endif; ?>
                </a>
                <a href="<?php echo e(route('admin.panorama-requests.index')); ?>" class="d-flex justify-content-between align-items-center <?php echo e(request()->routeIs('admin.panorama-requests.*') ? 'active' : ''); ?>">
                    <span>Yêu cầu tour 360</span>
                    <?php
                        $pendingPanoReqCount = \App\Models\PanoramaServiceRequest::where('status', 'pending')->count();
                    ?>
                    <?php if($pendingPanoReqCount > 0): ?>
                        <span class="badge-count"><?php echo e($pendingPanoReqCount); ?></span>
                    <?php endif; ?>
                </a>
            </nav>
            ...
            <nav>
                ...
                <a href="<?php echo e(route('admin.comments.index')); ?>" class="<?php echo e(request()->routeIs('admin.comments.*') ? 'active' : ''); ?>">
                    Quản lý bình luận
                </a>
                <div class="sidebar-nav-group <?php echo e($contribOpen ? 'open' : ''); ?>">
                    <button type="button" class="sidebar-nav-toggle" aria-expanded="<?php echo e($contribOpen ? 'true' : 'false'); ?>">
                        <span class="d-flex align-items-center gap-2">
                            <span>Quản lý đóng góp</span>
                            <?php if($pendingSuggestions > 0): ?>
                                <span class="badge-count"><?php echo e($pendingSuggestions); ?></span>
                            <?php endif; ?>
                        </span>
                        <i class="fas fa-chevron-down sidebar-chevron"></i>
                    </button>
                    <div class="sidebar-subnav">
                        <a href="<?php echo e(route('admin.contributions.index')); ?>" class="<?php echo e($contribOpen ? 'active' : ''); ?>">
                            Đề xuất địa điểm
                            <?php if($pendingSuggestions > 0): ?>
                                <span class="badge-count ms-1"><?php echo e($pendingSuggestions); ?></span>
                            <?php endif; ?>
                        </a>
                    </div>
                </div>
            ...
            <nav>
                <div class="sidebar-nav-group <?php echo e($reportsOpen ? 'open' : ''); ?>" id="sidebarReportsGroup">
                    <button type="button" class="sidebar-nav-toggle" id="sidebarReportsToggle" aria-expanded="<?php echo e($reportsOpen ? 'true' : 'false'); ?>">
                        <span class="d-flex align-items-center gap-2">
                            <span>Báo cáo vi phạm</span>
                            <?php if($pendingReportsTotal > 0): ?>
                                <span class="badge-count"><?php echo e($pendingReportsTotal); ?></span>
                            <?php endif; ?>
                        </span>
                        <i class="fas fa-chevron-down sidebar-chevron"></i>
                    </button>
                    <div class="sidebar-subnav">
                        <a href="<?php echo e(route('admin.reports.index', ['tab' => 'locations'])); ?>"
                           class="<?php echo e($reportsOpen && $reportTab === 'locations' ? 'active' : ''); ?>">
                            Địa điểm
                            <?php if($pendingReportLocations > 0): ?>
                                <span class="badge-count ms-1"><?php echo e($pendingReportLocations); ?></span>
                            <?php endif; ?>
                        </a>
                        <a href="<?php echo e(route('admin.reports.index', ['tab' => 'comments'])); ?>"
                           class="<?php echo e($reportsOpen && $reportTab === 'comments' ? 'active' : ''); ?>">
                            Bình luận
                            <?php if($pendingReportComments > 0): ?>
                                <span class="badge-count ms-1"><?php echo e($pendingReportComments); ?></span>
                            <?php endif; ?>
                        </a>
                        <a href="<?php echo e(route('admin.reports.index', ['tab' => 'feedbacks'])); ?>"
                           class="<?php echo e($reportsOpen && $reportTab === 'feedbacks' ? 'active' : ''); ?>">
                            Góp ý / báo lỗi
                            <?php if($pendingFeedbacks > 0): ?>
                                <span class="badge-count ms-1"><?php echo e($pendingFeedbacks); ?></span>
                            <?php endif; ?>
                        </a>
                    </div>
                </div>
...
<?php endif; ?>
                        <span><?php echo e(Auth::user()->display_name ?? Auth::user()->username ?? 'Admin'); ?></span>
                    </div>
            ...
            <main class="content-area">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom">
                    <div class="admin-workspace-crumb">
                        <span><?php echo e($adminCrumbGroup); ?></span>
                        <span class="sep">/</span>
...
</html><?php /**PATH D:\laragon\www\DuAn_TN-main\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>